...
class LibraryCommands(MusicSubCommand):
    ...
    def setup_parser(self, parser: argparse.ArgumentParser) -> None:
        """
        Configure le parser pour les commandes de biblioth�que.

        Args:
            parser: Sous-parser pour la cat�gorie 'library'
        """
        ...
        parser.description = "G�rer la biblioth�que musicale Alexa"
    ...
    def execute(self, args: argparse.Namespace) -> bool:
        """
        Ex�cute la commande de biblioth�que selon l'action.
