...
class TuneInManager(BaseManager[Dict[str, Any]]):
    ...
    def __init__(self, auth_or_http: Any, config: Any, state_machine: Any = None, api_service: Any = None) -> None:
        ...
        logger.info("TuneInManager initialis� avec AlexaAPIService obligatoire")
    ...
    def get_favorites(self) -> List[Dict[str, Any]]:
        """R�cup�re les stations favorites."""
        with self._lock:
            if not self.state_machine.can_execute_commands:
                return []
            try:
                ...
                logger.error(f"Erreur r�cup�ration favoris: {e}")
                return []
    ...
    def add_favorite(self, station_id: str) -> bool:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.success(f"Station {station_id} ajout�e aux favoris")
                return True
            except Exception as e:
