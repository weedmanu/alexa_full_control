...
class DeviceCommand(BaseCommand):
    ...
    def setup_parser(self, parser: argparse.ArgumentParser) -> None:
        ...
        parser.description = "G�rer les appareils Alexa connect�s"
        ...
        list_parser.add_argument("--json", action="store_true", help="Afficher les donn�es au format JSON")
        ...
        info_parser.add_argument("--json", action="store_true", help="Afficher les donn�es au format JSON")
        ...
        send_parser = subparsers.add_parser(
            "send",
            help="Envoyer un message � un appareil",
            formatter_class=ActionHelpFormatter,
        )
    ...
    def execute(self, args: argparse.Namespace) -> bool:
        ...
        # 'list' peut fonctionner en cache � combiner les conditions pour plus de clart�
            ...
            if hasattr(args, "refresh") and args.refresh:
                ...
                if not ctx.sync_service:
                    ...
                    try:
                        ...
                        self.success("? Synchronisation termin�e")
    ...
    def _display_devices_table(self, devices: List[Dict[str, Any]]) -> None:
        ...
        """
        self.info(f"?? {len(devices)} appareil(s) trouv�(s):\n")
        ...
        # Afficher le tableau
        table = self.format_table(table_data, ["Nom", "Type", "Famille", "�tat", "Serial"])
        print(table)
    ...
    def _get_volume(self, args: argparse.Namespace) -> bool:
        ...
        try:
            ...
            self.info(f"?? R�cup�ration volume de '{args.device}'...")
    ...
    def _set_volume(self, args: argparse.Namespace) -> bool:
        ...
        try:
            ...
            self.info(f"?? R�glage volume '{args.device}' ? {args.level}%...")
            ...
            if result:
                self.success(f"? Volume d�fini � {args.level}%")
                return True
    ...
    def _send_message(self, args: argparse.Namespace) -> bool:
        """
        Envoie un message (annonce vocale) � un appareil via l'API Alexa.Speak.
        ...
        try:
            ...
            self.info(f"?? Envoi message � '{args.device}'...")
            ...
            if result:
                self.success(f"? Message envoy� � '{args.device}': '{args.message}'")
                return True
