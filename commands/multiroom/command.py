...
class MultiroomCommand(BaseCommand):
    ...
    def _display_groups(self, groups: Any, verbose: bool = False) -> None:
        ...
        groups peut �tre soit un dict {normalized_name: group_data} soit une
        liste de dicts. Nous normalisons l'it�ration pour mypy et pour
        �viter les branches inaccessibles.
        """
        try:
            count = len(groups)
        except Exception:
        ...
        # Normaliser l'it�rable des groupes
