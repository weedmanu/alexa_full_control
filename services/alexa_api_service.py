...
class AlexaAPIService:
    ...
    def __init__(
        ...
        if args:
            ...
            class _AuthSessionShim:
                def __init__(self, auth_obj: Any):
                    self._a = auth_obj
                ...
                def request(self, method: str, url: str, **kw: Any) -> Any:
                    ...
                    if m == "put":
                        return self._a.put(url, **kw)
                    if m == "delete":
                        return self._a.delete(url, **kw)
    ...
    def _resolve_path(self, key_or_path: str) -> str:
        if key_or_path.startswith("http"):
            return key_or_path
        if key_or_path in self.ENDPOINTS:
            return self.ENDPOINTS[key_or_path]
