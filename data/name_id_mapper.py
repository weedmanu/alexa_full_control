...
This module mirrors `utils/name_id_mapper.py` but is placed under `data/`
so project-wide helpers that operate on dataset-like structures live in
`data/` alongside other mapping files.
"""
